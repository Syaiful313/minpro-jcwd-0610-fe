...
const Footer = () => {
  return (
    <div className="bg-[#222831] text-white p-8">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="text-center md:text-left">
          <h3 className="text-2xl font-bold mb-4 text-[#47cad2]">EventNesia</h3>
          <div className="space-y-4">
            <div className="pb-4 border-b border-gray-700">
              <p className="font-medium text-lg mb-2">Hubungi Kami:</p>
              <p className="flex items-center gap-2 mb-1">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-[#47cad2]" viewBox="0 0 20 20" fill="currentColor">
              ...
              <p className="flex items-center gap-2">
                ...
                serendepityid@gmail.com
              </p>
            </div>
            <div>
              <p className="font-medium text-lg mb-2">Layanan Pengaduan Konsumen:</p>
            ...
            <div className="pt-4 border-t border-gray-700">
              <p className="font-medium text-lg mb-1">Toko Offline Kami:</p>
              <p className="flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-[#47cad2]" viewBox="0 0 20 20" fill="currentColor">
        ...
        <div className="flex flex-col justify-center items-center">
          <div className="p-4 text-center mb-4">
            <h3 className="font-bold text-2xl text-[#47cad2] mb-2">Thanks For Visiting Us!</h3>
            <p className="text-lg">Follow Our Social Media:</p>
          </div>
          <div className="flex flex-wrap justify-center gap-6">
            <a
              href="https://www.instagram.com/serendipity_id.21/"
              className="social-link group"
              aria-label="Instagram"
            >
              <div className="w-12 h-12 rounded-full bg-[#222831] border-2 border-[#47cad2] flex items-center justify-center group-hover:bg-[#47cad2] transition duration-300">
                <svg
                  fill="none"
                  viewBox="0 0 22 22"
                  height="22"
                ...
                >
                  <path
                    ...
                    fill="white"
                    className="group-hover:fill-[#222831]"
                  ></path>
                  <path
      ...
      <div className="container mx-auto mt-8 pt-6 border-t border-gray-700 text-center text-sm text-gray-400">
        <p>© {new Date().getFullYear()} Event Serendipity. All rights reserved.</p>
      </div>
    </div>
  )
}
